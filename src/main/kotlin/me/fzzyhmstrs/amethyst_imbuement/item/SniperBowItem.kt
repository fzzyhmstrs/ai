...
class SniperBowItem(settings: Settings) :  CrossbowItem(settings) {
    ...
    companion object{
        ...
        private val SNIPER_BOW_SCOPE_LIST = arrayOf(AI.identity("textures/misc/sniper_bow_scope_0.png"),
            Identifier("minecraft","textures/misc/spyglass_scope.png"),
            AI.identity("textures/misc/sniper_bow_scope_6.png"),
            AI.identity("textures/misc/sniper_bow_scope_5.png"),
            AI.identity("textures/misc/sniper_bow_scope_4.png"),
            AI.identity("textures/misc/sniper_bow_scope_3.png"),
            AI.identity("textures/misc/sniper_bow_scope_2.png"),
            AI.identity("textures/misc/sniper_bow_scope_1.png")) //arranging it like this so scrolling down moves through the custom crosshairs and ends at the spyglass, not the other way around. figure scrolling down is more common
