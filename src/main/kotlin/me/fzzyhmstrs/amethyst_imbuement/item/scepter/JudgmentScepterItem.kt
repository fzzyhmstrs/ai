...
class JudgmentScepterItem(material: ScepterToolMaterial, settings: Settings): CustomSpellbladeItem(material,3,-2.7f, settings) {

    companion object{
        private val SMALL_DUST = DustParticleEffect(DustParticleEffect.RED,0.8f)
    }

    override val fallbackId: Identifier = Identifier(AI.MOD_ID,"execute")
