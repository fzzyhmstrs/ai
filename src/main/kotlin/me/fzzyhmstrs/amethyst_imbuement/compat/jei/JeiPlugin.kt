...
object JeiPlugin: IModPlugin {
    ...
    override fun registerRecipeTransferHandlers(registration: IRecipeTransferRegistration) {
        ...
        registration.addRecipeTransferHandler(CrystalAltarScreenHandler::class.java, RegisterHandler.CRYSTAL_ALTAR_SCREEN_HANDLER, JeiAltarCategory.ENHANCING_TYPE, 0, 3, 4, 36)
    }
