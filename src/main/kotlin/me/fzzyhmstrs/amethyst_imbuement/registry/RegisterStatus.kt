...
object RegisterStatus {
    ...
    val SOUL_SHIELD: StatusEffect = CustomStatusEffect(StatusEffectCategory.BENEFICIAL,0x60F5FA)
    ...
    fun registerAll(){
        ...
        Registry.register(Registries.STATUS_EFFECT, AI.identity("soul_shield"), SOUL_SHIELD)
