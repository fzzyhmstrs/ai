...
object RegisterStatus {
    ...
    val BLESSED: StatusEffect = BlessedStatusEffect(StatusEffectCategory.BENEFICIAL,0xFFFFFF)
    ...
    fun registerAll(){
        ...
        Registry.register(Registry.STATUS_EFFECT, Identifier(AI.MOD_ID,"blessed"), BLESSED)
        Registry.register(Registry.STATUS_EFFECT, Identifier(AI.MOD_ID,"insightful"), INSIGHTFUL)
    }
}
