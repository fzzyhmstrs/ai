...
object RegisterItemModel {
    ...
    fun registerAll(){
        ...
        val sparkingScepterModels = ItemModelRegistry.ModelIdentifierPerModes(ModelIdentifier(AI.MOD_ID + ":sparking_scepter#inventory"))
            .withHeld(ModelIdentifier(AI.MOD_ID + ":sparking_scepter_in_hand#inventory"), true)
        ItemModelRegistry.registerItemModelId(RegisterItem.SPARKING_SCEPTER, sparkingScepterModels)
