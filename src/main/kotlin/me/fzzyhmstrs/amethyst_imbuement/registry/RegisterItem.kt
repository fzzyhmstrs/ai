...
object RegisterItem {
    ...
    val CHARGED_MOONSTONE = CustomFlavorItem(FabricItemSettings().group(ItemGroup.MISC).rarity(Rarity.UNCOMMON)).withGlint().withFlavorDefaultPath(Identifier(AI.MOD_ID,"charged_moonstone")).also{ regItem["charged_moonstone"] = it}
    val ENERGETIC_OPAL = CustomFlavorItem(FabricItemSettings().group(ItemGroup.MISC).rarity(Rarity.UNCOMMON)).withGlint().withFlavorDefaultPath(Identifier(AI.MOD_ID,"energetic_opal")).also{ regItem["energetic_opal"] = it}
