...
object RegisterEnchantment {
    ...
    val REBINDING = RebindingAugment(Enchantment.Rarity.VERY_RARE,2, EquipmentSlot.OFFHAND).register("rebinding")
    ...
    val ENERGY_BLADE = EnergyBladeAugment().register("energy_blade")
