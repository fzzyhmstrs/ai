...
import me.fzzyhmstrs.amethyst_imbuement.entity.living.AttackTicksGolemEntity
...
class SardonyxElementalEntityModel(private val root: ModelPart) : SinglePartEntityModel<AttackTicksGolemEntity>() {
    ...
    override fun animateModel(crystalGolemEntity: AttackTicksGolemEntity, f: Float, g: Float, h: Float) {
