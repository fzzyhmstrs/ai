...
class LightningAuraAugment: MinorSupportAugment(ScepterTier.THREE,7){
    ...
    override fun augmentStat(imbueLevel: Int): AugmentDatapoint {
        return AugmentDatapoint(SpellType.WIT, 12000, 750,
            22, imbueLevel, 100, BookOfTalesItem.TALES_TIER, Items.CRYING_OBSIDIAN)
    }
    ...
    override fun supportEffect(
        ...
        user.addStatusEffect(StatusEffectInstance(RegisterStatus.ARCANE_AURA, -1, (effects.amplifier(level)/3)))
