...
class ImbuedFamiliarEntity(entityType: EntityType<ImbuedFamiliarEntity>, world: World): GolemEntity(entityType,world),
    Angerable, PlayerCreatable {

    constructor(entityType: EntityType<ImbuedFamiliarEntity>, world: World, ageLimit: Int, createdBy: LivingEntity? = null, bonusEquips: Int = 0, modDamage: Double = 0.0, modHealth: Double = 0.0) : this(entityType, world){
