            ...
            for (j in -1..1){
                for (k in -1..1){
                    ...
                    if (bsY.isAir || bsY.block is PlantBlock ){
                        ...
                        world.createAndScheduleBlockTick(posY.add(j,0,k),RegisterBlock.FORCEFIELD_BLOCK, getAge(world, baseAge))
                        successes++
                    ...
                    if (bsZ.isAir || bsZ.block is PlantBlock){
                        ...
                        world.createAndScheduleBlockTick(posZ.add(j,k,0),RegisterBlock.FORCEFIELD_BLOCK, getAge(world, baseAge))
                        successes++
