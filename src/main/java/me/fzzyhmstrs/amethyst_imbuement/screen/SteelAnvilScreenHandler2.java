...
public class SteelAnvilScreenHandler2
    ...
    public SteelAnvilScreenHandler2(int syncId, PlayerInventory inventory) {
        this(syncId, inventory, ScreenHandlerContext.EMPTY);
    }

    public SteelAnvilScreenHandler2(int syncId, PlayerInventory inventory, ScreenHandlerContext context) {
    ...
    protected boolean canUse(BlockState state) {
        return false; //state.isIn(RegisterTag.INSTANCE.getSTEEL_ANVIL_TAG());
    }
